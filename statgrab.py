...
SG_ERROR_INVALID_ARGUMENT = _statgrab.py_SG_ERROR_INVALID_ARGUMENT
SG_ERROR_ASPRINTF = _statgrab.py_SG_ERROR_ASPRINTF
SG_ERROR_SPRINTF = _statgrab.py_SG_ERROR_SPRINTF
SG_ERROR_DEVICES = _statgrab.py_SG_ERROR_DEVICES
...
SG_ERROR_DISKINFO = _statgrab.py_SG_ERROR_DISKINFO
...
SG_ERROR_HOST = _statgrab.py_SG_ERROR_HOST
...
SG_ERROR_MEMSTATUS = _statgrab.py_SG_ERROR_MEMSTATUS
SG_ERROR_OPEN = _statgrab.py_SG_ERROR_OPEN
SG_ERROR_OPENDIR = _statgrab.py_SG_ERROR_OPENDIR
SG_ERROR_READDIR = _statgrab.py_SG_ERROR_READDIR
SG_ERROR_PARSE = _statgrab.py_SG_ERROR_PARSE
SG_ERROR_PDHADD = _statgrab.py_SG_ERROR_PDHADD
SG_ERROR_PDHCOLLECT = _statgrab.py_SG_ERROR_PDHCOLLECT
SG_ERROR_PDHOPEN = _statgrab.py_SG_ERROR_PDHOPEN
SG_ERROR_PDHREAD = _statgrab.py_SG_ERROR_PDHREAD
SG_ERROR_PERMISSION = _statgrab.py_SG_ERROR_PERMISSION
SG_ERROR_PSTAT = _statgrab.py_SG_ERROR_PSTAT
...
SG_ERROR_SYSINFO = _statgrab.py_SG_ERROR_SYSINFO
SG_ERROR_MACHCALL = _statgrab.py_SG_ERROR_MACHCALL
SG_ERROR_IOKIT = _statgrab.py_SG_ERROR_IOKIT
...
SG_ERROR_GETMSG = _statgrab.py_SG_ERROR_GETMSG
SG_ERROR_PUTMSG = _statgrab.py_SG_ERROR_PUTMSG
SG_ERROR_INITIALISATION = _statgrab.py_SG_ERROR_INITIALISATION
SG_ERROR_MUTEX_LOCK = _statgrab.py_SG_ERROR_MUTEX_LOCK
SG_ERROR_MUTEX_UNLOCK = _statgrab.py_SG_ERROR_MUTEX_UNLOCK
...
SG_IFACE_DOWN = _statgrab.py_SG_IFACE_DOWN
SG_IFACE_UP = _statgrab.py_SG_IFACE_UP
